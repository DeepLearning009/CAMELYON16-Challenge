...
class CrossSlideTrainer:
    ...
    def Train(self, DbatchSize = 60,trainStep = 60, trainTimes = 10):
        ...
        window_H = window_W = self._win_size
        windowShape = (window_H, window_W)
        EXTwindow_H = EXTwindow_W = self._win_size +int(self._win_size*0.1)
...
if __name__ == '__main__':
    solverPath = "/media/hjlin/CULab1/zHJProgram/Camelyon_VGGRes_L1/ResSolver.prototxt"
    weightPath = "/media/hjlin/CULab1/zHJProgram/Camelyon_VGGRes_L1/ResSnapshots_L1/Camelyon_Res_L1.caffemodel"
    VGGcsvDir =  "/media/hjlin/CULab1/zHJProgram/Camelyon_VGGRes_L1/ResSnapshots_L1"
    outputDir =  "/media/hjlin/CULab1/zHJProgram/Camelyon_VGGRes_L1/ResSnapshots_L1"
