...
if __name__ == '__main__':
    outputDir = "/media/hjlin/CULab1/zHJProgram/Camelyon_VGG_L1/Detecter/RefinedResults"
    ...
    for i in xrange(1,111):
        if i not in Ex_list :
            ...
            csvPath = "/media/hjlin/CULab1/zHJProgram/Camelyon_VGG_L1/Tmp_V1/T8(9216,9948)/TrainData/Results/Tumor_%03d.csv" %i
