...
if __name__ == '__main__':
    ...
    TRAINED_MODEL_FILE = "/media/hjlin/HJLin_Disk/zHJProgram/Camelyon_VGG_L1/Camelyon_VGG_L1.caffemodel"
    outputDir =          "/media/hjlin/HJLin_Disk/zHJProgram/Camelyon_VGG_L1/Results"
    ...
    for i in T_list:
        if i not in Ex_list and i not in Test_list:
            ...
            tester.DetectWithMask(slidePath, maskPath, DbatchSize = 100)
