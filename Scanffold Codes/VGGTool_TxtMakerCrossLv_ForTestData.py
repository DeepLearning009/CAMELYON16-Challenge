        ...
        if os.path.exists(self._outputDir + "/" +dataName+"_coor.txt"):
            ...
            while(w<zero_level_size[0] and stop_flag_1 == False):
                ...
                while(h<zero_level_size[1] and stop_flag_2 == False):
                    ...
                    OVslideTile = cv2.resize(OVslideTile,(self._win_size,self._win_size)).astype('float32')
...
if __name__ == '__main__':
    outputDir = "/media/hjlin/CULab1/zHJProgram/Camelyon_Res_NewFrame/Tmp_s112"
