...
class CrossSlideTrainer:
    ...
    def Train(self, DbatchSize = 60,trainStep = 60, trainTimes = 10):
        ...
        window_H = window_W = self._win_size
        windowShape = (window_H, window_W)
        EXTwindow_H = EXTwindow_W = self._win_size +int(self._win_size*0.5)
...
if __name__ == '__main__':
    solverPath = "./ResSolver.prototxt"
    weightPath = "./ResSnapshots_L2/Camelyon_Res_L2.caffemodel"
    VGGcsvDir =  "./ResSnapshots_L2"
    outputDir =  "./ResSnapshots_L2"
    
    NET_FILE =   "./Res-152-deploy.prototxt"
    ...
    train_list = [2,4,5,10,12,13,19,22,24,25,27,30,34,35,40,43,48,53,57,59,60,61,67,69]
