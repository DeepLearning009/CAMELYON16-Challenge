...
if __name__ == '__main__':
    ...
    weightPath = "./ResSnapshots_L1/Camelyon_Res_L1.caffemodel"
    VGGcsvDir =  "./ResSnapshots_L1"
    outputDir =  "./ResSnapshots_L1"
    ...
    train_list = [2,4,5,12,13,19,22,24,27,30,34,35,40,43,48,53,57,59,60,61,67,69]
