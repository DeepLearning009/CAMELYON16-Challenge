...
if __name__ == '__main__':        
    ...
    VGG_NET_FILE =           "../VGG_16_deploy.prototxt"
    VGG_TRAINED_MODEL_FILE = "./Camelyon_VGG_L1.caffemodel"   
    Res_NET_FILE =           "../Res-152-deploy.prototxt"
    Res_TRAINED_MODEL_FILE = "./Camelyon_Res_L0.caffemodel" 
