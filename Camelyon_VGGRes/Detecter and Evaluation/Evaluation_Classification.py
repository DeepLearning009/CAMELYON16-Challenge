...
if __name__ == '__main__':
    csv_folder = "/media/hjlin/CULab1/zHJProgram/Camelyon_VGGRes_L1/DetectTestData/Results/Locations"
    result_folder = "/media/hjlin/CULab1/zHJProgram/Camelyon_VGGRes_L1/DetectTestData/Results/Classification"
    overallCsvFileName = "ClassifyResults.csv"
    result_file_list = []
    result_file_list += [each for each in os.listdir(csv_folder) if each.endswith('.csv')]
    ...
    for case in result_file_list:
        ...
        sys.stdout.flush()
        csvDIR = os.path.join(csv_folder, case)
